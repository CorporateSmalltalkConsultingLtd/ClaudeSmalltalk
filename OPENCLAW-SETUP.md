...
This guide explains how to set up the Smalltalk skill for [OpenClaw](https://github.com/openclaw/openclaw).
...
cp openclaw/smalltalk_projects.py ~/clawd/skills/smalltalk/openclaw/
cp openclaw/st ~/clawd/skills/smalltalk/openclaw/
chmod +x ~/clawd/skills/smalltalk/openclaw/smalltalk.py
chmod +x ~/clawd/skills/smalltalk/openclaw/smalltalk-daemon.py
chmod +x ~/clawd/skills/smalltalk/openclaw/smalltalk-dev-daemon.py
...
Expected output:
```
🔍 Checking OpenClaw Smalltalk setup...
...
```bash
python3 ~/clawd/skills/smalltalk/openclaw/smalltalk-daemon.py stop
```
...
[Service]
Type=simple
ExecStart=/usr/bin/python3 %h/clawd/skills/smalltalk/openclaw/smalltalk-daemon.py start
Restart=on-failure
RestartSec=5
...
Once set up, ask OpenClaw things like:
